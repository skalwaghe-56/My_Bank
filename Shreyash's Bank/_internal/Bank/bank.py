...
def lock_login():
    if cusidentry.get() == "Customer ID" or passwordentry.get() == "Password":
        ...
        def transfer_window():
           ...
           img = ImageTk.PhotoImage(file="Transfer.png")
        ...
        def withdraw_window():
           ...
           img = ImageTk.PhotoImage(file="Withdraw.png")
        ...
        def deposit_window():
           ...
           img = ImageTk.PhotoImage(file="Deposit.png")
        ...
        def close_acc():
           ...
           img = ImageTk.PhotoImage(file="DeleteA_C.png")
        ...
        def checkfor_updates():
               try:
                  r = urllib3.request("GET","https://flared-zip.000webhostapp.com/Bank/bank_version.txt")
                  ...
                  if data != _version_:
                     ...
                     if result == True:
                        webbrowser.open_new_tab("https://flared-zip.000webhostapp.com/Bank/Bank_setup.zip")
                        bank_window.destroy()
                     else:
                        return
                  else:
        ...
        img = ImageTk.PhotoImage(file="Bank.png")
