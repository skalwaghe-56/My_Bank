from tkinter import END,Label,Entry,Frame,Button,Tk,PhotoImage,Toplevel
...
def forgot_pass():
   ...
   bgPic = ImageTk.PhotoImage(file="_internal/background.jpg")
   ...
   user_entry = Entry(window,width=25,fg="magenta2",font=("arial",11,"bold"),bd=0,bg="grey")
   ...
   newpass_entry = Entry(window,width=25,fg="magenta2",font=("arial",11,"bold"),bd=0,bg="grey")
   ...
   confirmpass_entry = Entry(window,width=25,fg="magenta2",font=("arial",11,"bold"),bd=0,bg="grey")
...
def show():
    closeeye.config(file="_internal/openeye.png")
    passwordEntry.config(show="")
    eyeButton.config(command=hide)

def hide():
    closeeye.config(file="_internal/closeye.png")
    passwordEntry.config(show="*")
...
img = PhotoImage(file="_internal/Signin.png")
login_window.iconphoto(False,img)

bgImage = ImageTk.PhotoImage(file="_internal/bg.jpg")
...
closeeye = PhotoImage(file="_internal/closeye.png")
...
facebook_logo = PhotoImage(file="_internal/facebook.png")
fbLabel = Label(login_window,image=facebook_logo,bg="white")
fbLabel.place(x=640,y=440)

google_logo = PhotoImage(file="_internal/google.png")
googleLabel = Label(login_window,image=google_logo,bg="white")
googleLabel.place(x=690,y=440)

twitter_logo = PhotoImage(file="_internal/twitter.png")
